...
public class JogoServiceTests : IDisposable
{
    ...
    public async Task CadastrarAsync_DeveRetornarConflict_QuandoJogoComMesmoNomeExistir()
    {
        ...
        resultado.Errors.Should().Contain(e => e.Contains("Já existe um jogo cadastrado"));
    ...
    [Fact]
    public async Task CadastrarAsync_DeveRetornarInvalid_QuandoDadosInvalidos()
    {
    ...
    [Fact]
    public async Task AlterarAsync_DeveRetornarNotFound_QuandoJogoNaoExistir()
    {
        // Arrange
        ...
        _mockJogoRepository.Setup(r => r.ObterPorIdAsync(dto.Id))
            .ReturnsAsync((Jogo?)null);

        // Act
        var resultado = await _jogoService.AlterarAsync(dto);
    ...
    [Fact]
    public async Task AlterarAsync_DeveRetornarConflict_QuandoNomeJaExistirEmOutroJogo()
    {
        // Arrange
        var jogoExistente = Jogo.New()
            .Id(1)
        ...
        {
            Id = 1,
            Nome = "Nome Conflitante", // Nome que já existe em outro jogo
            Valor = 69.99m,
            Desconto = 10,
    ...
    [Fact]
    public async Task AlterarAsync_DeveRetornarSucesso_QuandoDadosValidosESemConflito()
    {
        // Arrange
        var jogoExistente = Jogo.New()
            .Id(1)
    ...
    [Fact]
    public async Task AlterarAsync_DevePermitirMesmoNome_QuandoNaoAlterarNome()
    {
        // Arrange
        var jogoExistente = Jogo.New()
            .Id(1)
        ...
        {
            Id = 1,
            Nome = "Jogo Existente", // Mesmo nome
            Valor = 69.99m, // Alterando apenas outros campos
            Desconto = 10,
            Descricao = "Nova descrição"
        };
        ...
        // Assert
        resultado.IsSuccess.Should().BeTrue();
        // Não deve verificar conflito de nome quando nome não mudou
        _mockJogoRepository.Verify(r => r.ObterPorNomeAsync(It.IsAny<string>()), Times.Never);
    }
    ...
    [Fact]
    public void Dispose_DeveDisporUnitOfWork()
    {
        // Act
